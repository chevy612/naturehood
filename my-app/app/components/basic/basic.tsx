  ...
  return (
    <>
      {showSuccess && (
        <SuccessModal
          title="You're in!"
          message="Thanks for subscribing to the Naturehood community. We'll keep you updated on athlete collaborations, brand partnerships, and product news."
      ...
      <Section className={isDark ? "bg-[#141115]" : "bg-[#F5F5F5]"}>
        <Container>
          <div className="max-w-2xl mx-auto text-center">
            ...
            {error && (
              <p
                className="mt-4 text-sm text-[#FF4D4D]"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                {error}
              </p>
