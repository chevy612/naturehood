export default function Footer() {
  return (
    <footer className="bg-black text-white py-8 md:py-12 px-4 sm:px-6 md:px-10 lg:px-40">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex space-x-4 mt-4">
                ...
                <a href="https://www.instagram.com/naturehood.official/" className="text-gray-300 hover:text-white transition-colors">
                ...
                <a href="https://www.youtube.com/@naturehood.official" className="text-gray-300 hover:text-white transition-colors">
