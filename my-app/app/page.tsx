...
function HeroSection() {
  ...
  function IntroSection() {
    ...
    const description = "We work closely with athletes to develop professional sport and lifestyle content. This empowers athletes to compete not only on the track, but also in the digital space—where visibility creates opportunity."
    return (
      <>
    ...
    const steps = [
      {
        ...
        description: "We collaborate with athletes who are committed to performance and storytelling. Together, we create high-quality sport and lifestyle content that reflects their identity, discipline, and journey.",
        image: "/image/athlete-partnership.webp" // Replace with your actual image path
      },
      {
        number: "2",
        title: "Audience & Positioning",
        description: "Through consistent content and strategic branding, athletes grow a clearly defined audience—one that extends beyond sport and into culture, lifestyle, and performance-driven communities.",
        image: "/image/audience-positioning.webp" // Replace with your actual image path
      },
      {
        number: "3",
        title: "Brand Collaboration",
        description: "We connect athletes with businesses whose products or services naturally align with their audience. Campaigns are designed to be authentic, performance-driven, and story-led—rather than traditional advertising.",
